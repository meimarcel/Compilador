...
public class Lexico {
    ...
    private final static List<String> palavraReservadaList = asList("programa", "se", "entao", "senao", "enquanto", "faca", "ate", "repita",
            "inteiro", "real", "caractere", "caso", "escolha", "endescolha", "procedimento", "funcao", "de", "para", "fimse", "inicio", "fim");
    
    private final static String LINGUAGEM = "[a-zA-Z0-9\\;\\,\\.\\+\\-\\*\\(\\)\\<\\>\\:\\=\\{\\}\\/\\@\\s]";
    private static Pattern pattern = Pattern.compile(LINGUAGEM, Pattern.CASE_INSENSITIVE);
                    ...
                    switch(state) {
                        case 0 :
                            switch(chars[i]) {
                                ...
                                case "-" : state = 5; automato1 = false; automato2 = false; automato3 = true; break;
